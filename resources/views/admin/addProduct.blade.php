            ...
            <form method="POST" action="/admin/product/post" class="form-horizontal" enctype="multipart/form-data" role="form">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input-md" id="category" name="category" type="text"/>
                            </div><!-- /input-group -->
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input id="stock" name="stock" type="text" placeholder="库存" class="form-control input-md" >
